...
//        System.out.println("原文文件："+args[0]+"\n\n抄袭版论文文件："+args[1]+"\n\n答案文件："+args[2]+"\n");
        ...
        try {
            s3 = FileUtils.readFile(args[0]);
            s4 = FileUtils.readFile(args[1]);
        } catch (IOException e) {
...
//        System.out.println("======================================");
//        System.out.println(  hash4.hammingDistance(hash3) );//汉明距离
//        System.out.println(  hash3.getSemblance(hash4) );//获得文本相似度
        long l4 = System.currentTimeMillis();
//        System.out.println(l4-l3);//所耗费毫秒数
//        System.out.println("======================================");

        //利用拼接将double变成字符串
        return ""+hash3.getSemblance(hash4);
